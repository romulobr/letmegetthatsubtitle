...
function fetchToken(callback) {
  login(function (err, res) {
    if (err) {
      ...
      return callback(undefined, res.token);
    }
  });
}

function downloadSubtitleWithToken(token, filePath, lang, cb) {
...
function fileInfo(filePath, cb) {
 var result = {hash: undefined, stats: undefined};
...
exports.downloadSubtitleWithToken = downloadSubtitleWithToken
